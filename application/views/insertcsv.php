...
<div id="container">
    ...
    <h3>大～中ジャンルを選択</h3>
        ...
        <br>
        <br>
        <h3>CSVをコピペで入力してください（NGワードと訂正文）</h3>
		<br>
		<textarea rows="20" name="csvfile" cols="70"></textarea></br>
            <br>
            <label class="checkbox">
                  <input type="checkbox" name="wildcard" value="1">【重要】すべてのNGワードへ適用させる
            </label>
            <br><br>
